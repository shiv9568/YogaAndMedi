        ...
        <div className="container">
            ...
            <div className="asana">
                ...
                <div className="asanaCollection">
                    <div className="box"><img src="../images/kapal-bhati.jpg" alt="" /><span><a href="/heart/pranayam">Pranayam</a></span></div>
                    <div className="box"><img src="../images/step1-suryanamaskar.jpg" alt="" /><span><a href="/heart/suryanamaskar">Suryanamaskar</a></span></div>
                      <div className="box"><img src="../images/step7-suryanamaskar.jpg" alt="" /><span><a href="/heart/cobra">Cobra Pose</a></span></div>
                </div>
            </div>
        </div>
    </div>
